<?php /* Smarty version Smarty-3.1-DEV, created on 2016-05-12 10:14:03
...
?>
		<tr>
			...
			<td><input type="button" class="pd-list-op" value="修改"  id="edit-btn" 	> <input type="button" class="pd-list-op" value="删除"  ></td>
		</tr>
	<?php } ?>
</table>
